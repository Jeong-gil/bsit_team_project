      ...
      <div id="userMenu">
        <ul class="list_menu">
          <c:choose>
	          ...
	          <li class="menu none_sub"><a href="/member/login" class="link_menu">로그인</a>
	          </li>
	          <!---->
	          <li class="menu lst">
      ...
      <div id="headerLogo" class="layout-wrapper">
        <h1 class="logo">
          <a href="/" class="link_main">
            ...
            <img src="/images/jolly-main.png" alt="졸리스토어 로고" style="display: block; width: 120px; height: 120px;">
          </a>
        </h1>
      </div>
      <div id="gnb">
            ...
            <div class="gnb_main">
              ...
              <div id="side_search" class="gnb_search">
                <form action="/shop/goods/goods_search.php?&amp;" onsubmit="return searchTracking(this)">
                  ...
                  <input type="hidden" name="hid_pr_text" value="새해맞이 컬리 뷰티 페스티벌!">
                  ...
                  <input name="sword" type="text" id="sword" value="" required="required" label="검색어"
                    class="inp_search">
