...
<body>
	<header>
		<div id="header">
			<div id="userMenu">
				<ul class="list_menu">
					<li class="menu none_sub menu_join"><c:choose>
							<c:when test="${ sessionScope.name ne null }">
								<span class="ico6">웰컴</span>
								<a href="#" class="link_menu">${ sessionScope.name } 님▼</a>
								<ul class="sub">
						...
						<div class="gnb_main">
							<div class="gnb_mainul">
								<ul class="gnb">
									...
									<li><a href="/goods/allGoods" class="link new "> <span
											class="txt">신상품</span>
									</a></li>
							...
							<div id="side_search" class="gnb_search">
								<form action="/shop/goods/goods_search.php?&amp;"
									...
									<input type="hidden" id="edit" name="edit" value=""> <input
										name="sword" type="text" id="sword" value="" required
										label="검색어" v-model="searchBar" class="inp_search"> <input
										type="image"
...
//                document.getElementById("searchInit").style.opacity=0;
            }
         } //searchBar
      } // watch
