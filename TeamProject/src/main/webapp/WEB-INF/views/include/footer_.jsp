		...
		<div class="inner_footer">
			...
			<div class="company">
				<ul class="list">
					...
					<li>
						<a class="link" href="#">컬리소개영상</a>
					</li>
					<li>
						<a class="link" href="#" target="_blank">인재채용</a>
					</li>
					<li>
				...
				<a href="#" target="_blank" class="link">사업자정보 확인</a>
				<br>
				...
				<br>
				입점문의 :
				<a href="#" target="_blank" class="link">입점문의하기</a>
				<span class="bar">I</span>
				제휴문의 :
				<a href="#" class="link">business@kurlycorp.com</a>
				<br>
				채용문의 :
				<a href="#" class="link">recruit@kurlycorp.com</a>
				<br>
				팩스 : 070 - 7500 - 6098
				<span class="bar">I</span>
				이메일 :
				...
				<ul class="list_sns">
					...
					<li>
						<a href="https://www.youtube.com/channel/UCfpdjl5p1-1qKT7Xp4UQzQg" class="link_sns lst" target="_blank">
