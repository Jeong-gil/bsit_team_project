            ...
            <div class="write_form">
                <div class="write_vew login_view">
                    <form method="POST" name="form" id="form" action="/member/login">
                        <input type="text" name="m_id" size="20" tabindex="1" value placeholder="아이디를입력해주세요">
                        <input type="password" name="password" size="20" tabindex="2" value placeholder="비밀번호를입력해주세요">
